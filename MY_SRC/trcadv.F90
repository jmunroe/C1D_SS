...
CONTAINS
   ...
   SUBROUTINE trc_adv( kt )
      ...
      CASE ( 7 )   ;    CALL tra_adv_tvd_zts_bio( kt, nittrc000, 'TRC', r2dt, zun, zvn, zwn, trb, trn, tra, jptra, &
                                               &  nn_trcadv_tvd_zts, zz_biosink*SPREAD(SPREAD(e1e2t(:,:),3,jpk),4,jptra) )   !  TVD ZTS modified
      !
   ...
   SUBROUTINE trc_adv_ctl
      ...
      IF( ln_trcadv_tvd_zts)   ioptio = ioptio + 1
